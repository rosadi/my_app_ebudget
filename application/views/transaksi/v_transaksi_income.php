...
<?php echo form_open('transaksi/transaksi_income'); ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><b>Input Transkasi Income</b></h3>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" name="income" class="form-control" placeholder="input income">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($data_transaksi as $data): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('transaksi/transaksi_income_delete/'.$data['t_detail_id']) ?>">DELETE</a></td>
                                </tr>
                            <?php endforeach ?>
                            <tr>

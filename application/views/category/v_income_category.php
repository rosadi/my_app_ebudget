<div class="row">
  <div class="col-lg-12">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Category Income</li>
...
<div class="row">
  ...
  <div class="col-lg-12">
    ...
    <?php if ( $this->session->flashdata('category_income_input') == TRUE ): ?>
      <div class="alert alert-info alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        <b><?php echo $this->session->flashdata('category_income_input') ?></b>
      </a>.
    </div>
  <?php endif ?>
...
<div class="row">
  ...
  <div class="col-lg-12">
    ...
    <?php if ( $this->session->flashdata('category_income_update') == TRUE ): ?>
      <div class="alert alert-warning alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        <b><?php echo $this->session->flashdata('category_income_update') ?></b>
      </a>.
    </div>
  <?php endif ?>
...
<div class="row">
  ...
  <div class="col-lg-12">
    ...
    <?php if ( $this->session->flashdata('category_income_delete') == TRUE ): ?>
      <div class="alert alert-danger alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        <b><?php echo $this->session->flashdata('category_income_delete') ?></b>
      </a>.
    </div>
  <?php endif ?>
  ...
  <div class="col-lg-12">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"><b>Input data Category Income</b></h3>
      </div>
      <div class="panel-body">

        <?php echo form_open('category/category_income'); ?>
